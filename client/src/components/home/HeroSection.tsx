...
const HeroSection = () => {
    return(
        <div className="relative min-h-[80dvh] w-full flex items-center justify-center overflow-hidden">
            {/* Background image */}
            <div
            ...
            <div className="flex flex-col justify-around gap-8 max-w-3xl mx-auto text-center z-10">
                ...
                <h3 className="max-w-2xl mx-auto text-[var(--primary)] text-xl">Discover our curated collection of beautiful plants, flowers, and accessories. Transform your home into a natural sanctuary with nature delivered to your doorstep.</h3>
